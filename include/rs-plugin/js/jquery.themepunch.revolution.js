 ...
 var runSlider = function(container,opt) {
	...
	jQuery.each(opt.allli,function(index,li) {
		...
		if (li.data('link')!=undefined) {
			...
			var apptxt = '<div class="tp-caption slidelink" style="cursor:pointer;width:100%;height:100%;z-index.php:'+zindex+';" data-x="center" data-y="center" data-basealign="slide" ',
...
var prepareSlides = function(container,opt) {
	...
	opt.allli.find('>img').each(function(j) {
		...
		img.wrap('<div class="slotholder" style="position:absolute; top:0px; left:0px; z-index.php:0;width:100%;height:100%;"></div>');
