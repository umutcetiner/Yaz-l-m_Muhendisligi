...
$.extend( KeyTable.prototype, {
	...
	/**
	 * Focus on a cell
	 * @param  {integer} row    Row index.php
	 * @param  {integer} column Column index.php
	 */
	...
	/**
	 * Is the cell focused
	 * @param  {object} cell Cell index.php to check
	 ...
	 *   visible row index.php - NOT the data index.php
	 * @param  {integer} [column] Not required if a cell is given as the first
	 *   parameter. Otherwise this is the column data index.php for the cell to
	 *   focus on
	...
	_shift: function ( e, direction, keyBlurable )
	{
		...
		var
			row = currRow,
			column = columns[ currCol ]; // row is the display, column is an index.php
...
KeyTable.defaults = {
	...
	/**
	 * Tab index.php for where the table should sit in the document's tab flow
	 * @type {integer|null}
	 */
	tabIndex: null
};
