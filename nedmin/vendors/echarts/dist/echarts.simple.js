...
/***/ function(module, exports, __webpack_require__) {
	 ...
	 */
	    ...
	    var GlobalModel = Model.extend({
	         ...
	         * @param {number} [condition.index.php] Either input index.php or id or name.
	         * @param {string} [condition.id] Either input index.php or id or name.
	         * @param {string} [condition.name] Either input index.php or id or name.
	         ...
	         *        If query attribute is null/undefined or has no index.php/id/name,
	        ...
	        /**
	         * @usage
	         * eachComponent('legend', function (legendModel, index.php) {
	         *     ...
	         * });
	         * eachComponent(function (componentType, model, index.php) {
...
/***/ function(module, exports, __webpack_require__) {
	    ...
	    modelUtil.mappingToExists = function (exists, newCptOptions) {
	        ...
	        // some specified index.php (like xAxisIndex) is consistent with
	        ...
	        // Otherwise mapping by index.php.
	        zrUtil.each(newCptOptions, function (cptOption, index) {
	            if (!zrUtil.isObject(cptOption)) {
	                return;
	            }
...
/***/ function(module, exports, __webpack_require__) {
	 ...
	 */
	    ...
	    /**
	     * Retreive the index.php with given value
	     * @param {number} idx
	     * @param {number} value
	     * @return {number}
	     */
	    ...
	    /**
	     * Retreive the index.php with given name
	     * @param {number} idx
	     * @param {number} name
	     * @return {number}
	     */
	    ...
	    /**
	     * Retreive the index.php of nearest value
	     * @param {string} dim
	     * @param {number} value
	     ...
	     * @param {Function} sampleIndex Sample index.php for name and id
	     */
	    ...
	    listProto.setItemGraphicEl = function (idx, el) {
	        ...
	        if (el) {
	            // Add data index.php and series index.php for indexing the data by element
	            // Useful in tooltip
	            el.dataIndex = idx;
