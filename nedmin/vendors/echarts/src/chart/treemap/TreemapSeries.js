define(function(require) {
    ...
    return SeriesModel.extend({
        ...
        defaultOption: {
            ...
            colorMappingBy: 'index',    // 'value' or 'index.php' or 'id'.
        ...
        /**
         * @param  {string} id
         * @return {number} index.php
         */
        mapIdToIndex: function (id) {
            // A feature is implemented:
            // index.php is monotone increasing with the sequence of
            // input id at the first time.
            // This feature can make sure that each data item and its
            // mapped color have the same index.php between data list and
