...
$.extend( Buttons.prototype, {
	 ...
	 * @param  {int|string} Button index.php
	 * @return {function}
	 *//**
	 ...
	 * @param {int|string} [idx] Button index.php for where to insert the button
	 * @return {Buttons} Self for chaining
	 */
	 ...
	 * @param  {int|string} node Button index.php
	 * @return {string} Button text
	 *//**
	 * Set the text for a button
	 * @param  {int|string|function} node Button index.php
...
Buttons.buttonSelector = function ( insts, selector )
{
	...
	var run = function ( selector, inst ) {
		...
		if ( selector === null || selector === undefined || selector === '*' ) {
			...
			// Main button index.php selector
			ret.push( {
				inst: inst,
