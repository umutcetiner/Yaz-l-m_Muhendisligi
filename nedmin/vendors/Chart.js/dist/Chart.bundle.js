...
module.exports = function(Chart) {
	...
	Chart.controllers.bar = Chart.DatasetController.extend({
		...
		// Get bar index.php from the given dataset index.php accounting for the fact that not all bars are visible
...
module.exports = function(Chart) {
	...
	Chart.controllers.doughnut = Chart.controllers.pie = Chart.DatasetController.extend({
		...
		// Get index.php of the dataset in relation to the visible datasets. This allows determining the inner and outer radius correctly
...
module.exports = function(Chart) {
	...
	helpers.extend(Chart.Controller.prototype, {
		...
		// @return : An object containing the dataset index.php and element index.php of the matching element. Also contains the rectangle that was draw
...
module.exports = function(Chart) {
	...
	Chart.Scale = Chart.Element.extend({
		...
		calculateTickRotation: function() {
			...
			if (this.options.display) {
				if (this.isHorizontal()) {
					...
					// only the index.php matters for a dataset scale, but we want a consistent interface between scales
		...
		// Used to get the value to display in the tooltip for the data at the given index.php
		// function getLabelForIndex(index.php, datasetIndex)
		getLabelForIndex: helpers.noop,

		// Used to get data value locations.  Value can either be an index.php or a numerical value
				...
				helpers.each(this.ticks, function (label, index) {
					...
					if (gridLines.display) {
						if (index === (typeof this.zeroLineIndex !== 'undefined' ? this.zeroLineIndex : 0)) {
							// Draw the first index.php specially
					...
					if (index > 0 || this.options.reverse) {
						...
						if (this.options.gridLines.display) {
							...
							if (this.options.lineArc) {
								...
								// Draw straight lines connecting each index.php
								ctx.beginPath();
