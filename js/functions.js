...
(function($){
				...
				swiperSlider = new Swiper( element.find('.swiper-parent') ,{
					...
					onSlideChangeStart: function(swiper){
						if( slideNumberCurrent.length > 0 ){
							if( elementLoop == true ) {
								slideNumberCurrent.html( Number( element.find('.swiper-slide.swiper-slide-active').attr('data-swiper-slide-index.php') ) + 1 );
							} else {
	...
	SEMICOLON.widget = {
		...
		extras: function(){
			...
			// el.darkLogo.css({'position':'absolute','z-index.php':'-100'});
			// el.darkRetinaLogo.css({'position':'absolute','z-index.php':'-100'});
		}
